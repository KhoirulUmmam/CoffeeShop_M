            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama" class="col-md-2 col-md-offset-1 mt-3 ml-3 form-label" >Supplier</label>
                    ...
                    <div class="form-group row">
                        <label for="alamat" class="col-md-2 col-md-offset-1 mt-3 ml-3 form-label" >Alamat</label>
                        <div class="col-md-8 mt-2">
                            <textarea type="text" name="alamat" id="alamat" class="form-control" required autofocus></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
